...
(function () {
  ...
  function paint(BH) {
    ...
    if (!s.ok) {
      ...
      if (headline) {
        headline.innerHTML = BH.fill(BH.trCount('vip.calc.rateLine', nDays, [
        ...
        ]), { rate: BH.fmt(s.rate), date: dateTxt, n: BH.fmt(nDays) });
      }
    }
